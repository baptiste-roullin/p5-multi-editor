...
import { cleanUI } from "@/capture/CaptureUI"
import { Recorder } from "@/capture/recorders/base"
import { Mp4Recorder } from "@/capture/recorders/mp4-recorder"
import { WebmRecorder } from "@/capture/recorders/webm-recorder"
import { GifRecorder } from "@/capture/recorders/gif-recorder"
import { PngRecorder } from "@/capture/recorders/png-recorder"
import { JpgRecorder } from "@/capture/recorders/jpg-recorder"
import { WebpRecorder } from "@/capture/recorders/webp-recorder"
import { downloadBlob } from "@/capture/utils"
import { createUi } from "@/capture/CaptureUI"

import { type UiState } from "@/capture/CaptureUI"
import type { Mp4RecorderOptions } from "@/capture/recorders/mp4-recorder"
import type { WebmRecorderOptions } from "@/capture/recorders/webm-recorder"
import type { GifRecorderOptions } from "@/capture/recorders/gif-recorder"
import type { PngRecorderOptions } from "@/capture/recorders/png-recorder"
import type { JpgRecorderOptions } from "@/capture/recorders/jpg-recorder"
import type { WebpRecorderOptions } from "@/capture/recorders/webp-recorder"
import type { ImageFormat } from "@/capture/recorders/image-recorder"
...
export class P5Capture {
  ...
  initialize(p5: any) {
    ...
    if (!this.mergedOptions.disableUi) {
      ...
      //  cleanUI(P5Capture.globalOptions.targetElement)

      const { updateUi } = createUi(this.mergedOptions.targetElement, this.uiState, {
